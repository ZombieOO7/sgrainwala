              ...
              <div class="box box-primary">
				...
				<div class="box-body">
                    <div class="form-group">
						...
						<input type="text" class="form-control" name="username" id="disabledInput" value="<?php echo $username; ?>" disabled/>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="exampleInputEmail1">Old Password :</label><?php echo isset($error['old_password']) ? $error['old_password'] : '';?>
...
$('#change_password_form').validate({
	rules:{
		...
		new_password:{minlength:6, required:true},
