        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <?php
                    ...
                    $sql="SELECT * FROM settings WHERE id=13";
                    $db->sql($sql);
                ...
                <form id="system_configurations_form"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?=$res_logo[0]['value']?>" title='<?=$data['app_name']?> - Logo' alt='<?=(isset($data['app_name']))?$data['app_name']:"";?> - Logo' style="max-width:100%"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="currency" value="<?=$data['currency']?>" placeholder="Either Symbol or Code - For Example $ or USD"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="delivery_charge">Delivery Charge Amount (<?=$data['currency']?>)</label>
                        ...
                        <div class="form-group">
                            <label for="delivery_charge">Minimum Amount for Free Delivery (<?=$data['currency']?>) <small>( Below this user will be charged based on Delivery Charge)</small></label>
                        ...
                        <div class="form-group">
                            <label for="">Minimum Order Amount (<?=$data['currency']?>)</label>
                        ...
                        <div class="form-group">
                            <label for="">Refer & Earn Bonus (<?=$data['currency']?> OR %)</label>
                        ...
                        <div class="form-group">
                            <label for="">Maximum Refer & Earn Amount (<?=$data['currency']?>)</label>
