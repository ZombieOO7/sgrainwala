...
<section class="content">
              ...
              <div class="box box-primary">
                ...
                <form  method="post" id="add_form" action="public/db-operation.php">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-6" id="dihide">
                      <label for="">Discount</label>
                      <input type="text" class="form-control"  name="discount" id="discount">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="">Discount Type</label>
                        <select name="discount_type" id="type1" class="form-control">
                    ...
                    <div class="form-group col-md-6" id='mdihide'>
                    ...
                    <div class="col-md-12" id="products" style="display:none;">
                     ...
                     <div class="form-group col-md-6">
                            <label for="product">Free Products :</label>
                         ...
                         <div class="form-group col-md-6">
                        <label for="">Product varient</label>
                        
                            
                        <select name="product_varient" id="product_varient" class="form-control">
                            
                            <?php
                                    $sql1 = "SELECT * FROM `product_variant` order by id DESC";
                                    $db->sql($sql1);
                                    $products_result1 = $db->getResult();
                                    
                                ?>
                            <option value="">Select</option>
                            <?php foreach($products_result1 as $value1){?>
                            
                           <option id ="<?=$value1['product_id']?>" value="<?=$value1['id']?>"><?=$value1['measurement']?></option>
                           <?php
                                }
                                ?>
                           ...
                           <!-- <option value="1kg">1 kg</option>
                            ...
                            <option value="150gm">150 gm</option>
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group"    >
                            <label class="container">Google pay
                              <input  type="checkbox" value= "0" id="pay[]" name="pay[]">
                              
                            </label>
                            <label class="container">PayUmoney
                              <input type="checkbox"  value= "1" id="pay[]" name="pay[]" >
                              
                            </label>
                            <label class="container">COD
                              <input type="checkbox" value= "2" id="pay[]" name="pay[]" >
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover" data-toggle="table" id="promo-codes"
                        data-url="api/get-bootstrap-table-data.php?table=promo-codes"
    ...
    <div class="modal fade" id='editPromoCodeModal' tabindex="1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog modal-md" role="document">
                    ...
                    <div class="col-md-12" id="update_products" >
                        <div class="row">
                            
                     <div class="form-group col-md-6">
                            <label for="product">Free Products :</label>
                            <select name="free_product" id="update_free_product" class="form-control">
                                 <?php
                                    $sql = "SELECT * FROM `products` order by id DESC";
                                    $db->sql($sql);
                                    $products_result = $db->getResult();
                         ...
                         <div class="form-group col-md-6">
                        <label for="">Product varient</label>
                        <select name="product_varient" id="update_product_varient" class="form-control">
                            <option value="">Select</option>
                            <option value="1kg">1 kg</option>
                            <option value="500gm">500 gm</option>
                            <option value="250gm">250 gm</option>
                    ...
                    <script>
                        $('#update_discount_type').on('change', function() {
                              if(this.value == "free_product") {
                                $('#update_products').show();
                              } else {
                                $('#update_products').hide();
                              }
                            });
                            
                    </script>                    
                    <div class="form-group" id='mdihide'>
                      <label for="">Max Discount Amount</label>
  ...
  <script>
            window.actionEvents = {
                ...
                'click .edit-promo-code': function (e, value, row, index) {
                    ...
                    $('#update_free_product').val(row.free_product);
                    $('#update_product_varient').val(row.product_varient);
...
$("#free_product").change(function() {
  if ($(this).data('options') === undefined) {
    /*Taking an array of all options-2 and kind of embedding it on the select1*/
    $(this).data('options', $('#product_varient option').clone());
  }
  var id = $(this).val();
  var options = $(this).data('options').filter('[id=' + id + ']');
  $('#product_varient').html(options);
});
