                        ...
                        <table class="table no-margin table-striped" data-toggle="table"  id="order_list"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="user_id" data-sortable='true' data-footer-formatter="orderFormatter">User ID</th>
                                    ...
                                    <th data-field="total" data-sortable='false' data-footer-formatter="priceFormatter" data-visible='false'>Total Price(<?=$settings['currency']?>)</th>
                                    <th data-field="discount" data-sortable='false' data-visible='false'>Discounted_Price(<?=$settings['currency']?>)</th>
                                    <th data-field="delivery_charge" data-sortable='true' data-footer-formatter="delivery_chargeFormatter" data-visible='false'>Delivery Charge(<?=$settings['currency']?>)</th>
                                    <th data-field="discount" data-sortable='false' data-visible='false'>Discount%</th>
                                    ...
                                    <th data-field="delivery_time" data-sortable='true'>Delivery Time</th>
