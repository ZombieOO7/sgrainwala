...
--
-- Host: localhost:3306
-- Generation Time: Mar 28, 2020 at 06:04 PM
...
(45, 'What is GMart Fresh App?', 'GMart Fresh App is an Online Vegetables  & Fruits at your Doorstep Delivery that makes your shopping experience easier and hassle-free. We know how big is the pain of grocery shopping can be, and how we all dislike going to the store. But what if there was someone who could do it for you? This is where we step in. ', '2'),
(47, 'What is the minimum order value?', 'Minimum order of  Rs. 25 is required.', '2'),
(48, 'How can I pay you? ', 'Right now we accept payments via \'Cash on Delivery\' and PayTm on Delivery  but soon we will make \'Credit/Debit Card on Delivery\' method available.', '2'),
(50, 'How fast can you deliver? ', 'Keeping the fast paced lives today and emergencies in mind, we wish to deliver your order ASAP. In our case the maximum time limit would be 2 hours, but we would want to reach your doorstep sooner.', '0'),
(52, 'Can I change the delivery address of my order?', 'You cannot change the delivery address once the order is placed. You can cancel the previous order and place a new one.', '2');
...
CREATE TABLE `order_items` (
  ...
  `deliver_by` varchar(128) CHARACTER SET utf8 NOT NULL,
...
(12, 'contact_us', '<h2><strong>Contact Us</strong></h2>\r\n\r\n<p>For any kind of queries related to products, orders or services feel free to contact us on our official email address or phone number as given below :</p>\r\n\r\n<p><a href=\"mailto:info@wrteam.in\">info@wrteam.in</a></p>\r\n\r\n<p><a href=\"tel:+91 9876543210\">+91 9876543210</a></p>\r\n\r\n<h3><strong>Areas we deliver :&nbsp;</strong></h3>\r\n\r\n<p>Bhuj - Madhapar - Mirjapar</p>\r\n\r\n<h3><strong>Delivery Timings :</strong></h3>\r\n\r\n<ol>\r\n	<li><strong>&nbsp; 8:00 AM To 10:30 AM</strong></li>\r\n	<li><strong>10:30 AM To 12:30 PM</strong></li>\r\n	<li><strong>&nbsp; 4:00 PM To&nbsp; 7:00 PM</strong></li>\r\n</ol>\r\n\r\n<p><strong>Note : </strong>You can order for maximum 2days in advance. i.e., Today &amp; Tomorrow only.&nbsp;&nbsp;</p>\r\n\r\n<h3><strong>Store Location :&nbsp;</strong></h3>\r\n\r\n<p>Mirjapar Road, Bhuj - 370001</p>\r\n\r\n<h3>&nbsp;</h3>\r\n'),
(13, 'system_timezone', '{\"system_configurations\":\"1\",\"system_timezone_gmt\":\"+05:30\",\"system_configurations_id\":\"13\",\"app_name\":\"eKart\",\"support_number\":\"9876543210\",\"support_email\":\"support@ekart.com\",\"current_version\":\"1.0.0\",\"minimum_version_required\":\"1.0.0\",\"is-version-system-on\":\"0\",\"currency\":\"RS.\",\"tax\":\"30\",\"delivery_charge\":\"40\",\"min_amount\":\"500\",\"system_timezone\":\"Asia/Kolkata\",\"is-refer-earn-on\":\"0\",\"min-refer-earn-order-amount\":\"100\",\"refer-earn-bonus\":\"10\",\"refer-earn-method\":\"percentage\",\"max-refer-earn-amount\":\"100\",\"minimum-withdrawal-amount\":\"100\",\"max-product-return-days\":\"0\",\"delivery-boy-bonus-percentage\":\"2\",\"from_mail\":\"info@wrteam.in\",\"reply_to\":\"info@wrteam.in\"}'),
(14, 'payment_methods', '{\"paypal_payment_method\":\"1\",\"paypal_mode\":\"sandbox\",\"paypal_business_email\":\"seller@somedomain.com\",\"payumoney_payment_method\":\"0\",\"payumoney_merchant_key\":\"FGCWtd8L\",\"payumoney_merchant_id\":\"6928786\",\"payumoney_salt\":\"40QIgAPmii\"}');
...
(1, 'Morning 9AM to 12PM', '09:00:00', '12:00:00', '11:00:00', 1),
(2, 'Evening 4PM to 9PM', '16:00:00', '21:00:00', '19:00:00', 1);
...
CREATE TABLE `transactions` (
  ...
  `payu_txn_id` varchar(512) NOT NULL,
  `amount` double NOT NULL,
  `status` varchar(8) NOT NULL,
