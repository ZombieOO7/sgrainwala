...
define('DOMAIN_URL','https://sgrainwala.com/cart/'); /* change to your domain here */
...
class Database{
    ...
    private $db_user = "sgrainwala_sgrainwala";  // Change as required
    private $db_pass = "Sgr@inw@l@2525";  // Change as required
    private $db_name = "sgrainwala_sgrainwala";    // Change as required
