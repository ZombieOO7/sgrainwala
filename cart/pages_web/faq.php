	  ...
	  <?php
		if(isset($_POST['btnAdd'])){
			...
			if(!empty($query)){
				...
				if($result){
					$error['add_query'] = " <span class='label label-danger'>Successfully add query</span>";
				}else{
...
<section id="faq" class="col-md-12">
  <h2 class="page-header" ><a href="#" style="color:#014c8d;">FAQs</a></h2>
   <?php
	...
	<?PHP if(!empty($res[0]['question'])&&!empty($res[0]['answer'])){?>
	
  <h3 style="color:#f47c2e;"><?php echo $res[0]['question'];?></h3>
  <p class="lead"><?php echo $res[0]['answer'];?></p>
  <?php }} ?>
