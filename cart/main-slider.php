            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <form id="slider_form" method="post" action="api/slider-images.php" enctype="multipart/form-data">
                            <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <table id="notifications_table" class="table table-hover" data-toggle="table" 
                            data-url="api/get-bootstrap-table-data.php?table=slider"
